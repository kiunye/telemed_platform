...
config :telemed_api, TelemedApiWeb.Endpoint,
  ...
  render_errors: [
    formats: [json: TelemedApiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: TelemedApi.PubSub,
  live_view: [signing_salt: "fOrpmS3W"]
...
config :telemed_api, TelemedApi.Mailer, adapter: Swoosh.Adapters.Local
